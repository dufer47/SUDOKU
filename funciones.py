...
# Funcion para dibujar la barra superior
...
# Funcion para generar un nuevo Sudoku segun la dificultad
def generar_nuevo_sudoku(dificultad:int)->list:
    ...
    # Determinar la cantidad de celdas a ocultar segun la dificultad
    if dificultad == 0:
        celdas_a_ocultar = 16
    elif dificultad == 1:
        celdas_a_ocultar = 32
...
# Funcion para leer los puntajes desde un archivo JSON
...
# Funcion para calcular el puntaje final del jugador
def calcular_puntaje(dificultad_elegida:float, errores:int, tiempo_ms:int, incrementador_segun_dificultad:list, penalizacion_error:int=50, penalizacion_tiempo:int=10, puntos_base:int=1000)->float:
    ...
    """
    penalizacion_error_total = penalizacion_error * incrementador_segun_dificultad[dificultad_elegida]  # Penalizacion ajustada por dificultad
    penalizacion_tiempo_total = penalizacion_tiempo * incrementador_segun_dificultad[dificultad_elegida]  # Penalizacion ajustada por dificultad
